...
builder: (context) {
  return AlertDialog( 
    ...
    title: HelperText(text:"Exit",textColor: whiteText,),
    content: HelperText(text:"Are you sure that you want to Exit",textColor: whiteText,),
    
  actions: [  
  ElevatedButton(onPressed: (){
Navigator.pop(context);

  }, child: HelperText(text: "Cancel",fontsize: 15,),),
  ...
  }, child: HelperText(text: "Okk",fontsize: 15,),)
